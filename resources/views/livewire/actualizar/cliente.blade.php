    ...
    <div x-show="open" class="fixed inset-0 px-2 z-10 overflow-hidden flex items-center justify-center">
        ...
        <div x-show="open" x-transition:enter="transition-transform ease-out duration-300"
            ...
            <div class="p-4">
                ...
                @endif
                <form class="bg-white p-3 rounded-lg shadow-lg min-w-full" wire:submit.prevent="actualizarCliente">
                    <div>
                    ...
                    <div>
                        ...
                        <input class="w-full bg-gray-100 px-4 py-2 rounded-lg focus:outline-none" type="text"
                            name="email" id="email" placeholder="Email" wire:model="email" />
                        <div>
                            @error('email') <span class="error text-red-600">{{ $message }}</span> @enderror
                        </div>
                    </div>
                    <div>
                        <label class="text-gray-800 font-semibold block my-3 text-md" for="telefono">Teléfono</label>
                        <input class="w-full bg-gray-100 px-4 py-2 rounded-lg focus:outline-none" type="text"
                            name="telefono" id="telefono" placeholder="Teléfono" wire:model="telefono" />
                        <div>
                    ...
                    <div>
                        ...
                        <textarea class="w-full bg-gray-100 px-4 py-2 rounded-lg focus:outline-none" name="direccion" id="direccion" placeholder="Ingrese la informacion" wire:model="direccion"></textarea>
                        <div>
