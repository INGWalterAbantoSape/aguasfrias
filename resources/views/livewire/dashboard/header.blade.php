        ...
        <ul class="ml-auto flex items-center">
            ...
            <li class="dropdown ml-3">
                ...
                <ul
                    ...
                    <li>
                        <x-nav_aside_link :href="route('profile')" :active="request()->routeIs('profile')" wire:navigate>
                            {{ __('profile') }}
                        </x-nav_aside_link>
                    </li>
                    <li>
                    ...
                    <li>
                        <button wire:click="logout" class="px-4 py-2 text-sm font-medium text-white bg-red-600 rounded-md hover:bg-red-700 focus:outline-none focus:bg-red-700">
                            Logout
                        </button>
                    </li>
                </ul>
